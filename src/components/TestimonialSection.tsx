...
// Alumni logos are generated by scripts/split-alumni-logos.cjs and written to src/data/alumniLogos.json
import alumniLogos from "@/data/alumniLogos.json";

const alumniCompanies = (alumniLogos || []).map((src: string, idx: number) => ({ name: `Alumni ${idx+1}`, key: `alumni-${idx+1}`, src }));
